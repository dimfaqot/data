                ...
                <div class="modal-body">
                    <?php if (session('role') == 'Root') : ?>
                        ...
                        <select class="form-select add_val mb-2">
                            <?php foreach (options('Region') as $k => $i) : ?>
                                <option <?= $k == 0 ? 'selected' : ''; ?> value="<?= $i['value']; ?>"><?= $i['value']; ?></option>
                            <?php endforeach; ?>
                        </select>
                    <?php endif; ?>
                    <input data-val="<?= session('info'); ?>" data-role="<?= session('role'); ?>" type="text" data-col="region" class="form-control cari_nama_santri add_cari_nama_santri" data-target="add_cari_nama_santri" placeholder="Cari nama" required>
                    <div style="position:absolute;" class="body_add_cari_nama_santri"></div>

                    <div class="d-grid mt-3">
                        <button data-order="region" class="btn_main btn_add_data"><i class="fa-solid fa-floppy-disk"></i> Save</button>
                    </div>
                </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex">
                                ...
                                <div class="p-2 flex-shrink-1"><a href="" class="confirm_del" data-col="region" data-id="<?= $i['id']; ?>"><i style="font-size: medium;color:red" class="fa-solid fa-circle-xmark"></i></a></div>
                            </div>
                        </td>
                    </tr>
