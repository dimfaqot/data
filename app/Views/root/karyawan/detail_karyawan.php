        ...
        <form method="post" action="<?= base_url(menu()['controller']); ?>/update" class="card">
            ...
            <?php if (url('13') == 'Catatan') : ?>
                ...
                <div class="d-grid p-3">
                    <button type="submit" class="btn-sm btn_check btn_check btn_main"><i class="fa-solid fa-file-pen"></i> Update <?= url(13); ?></button>
                </div>
            ...
            <?php else : ?>
                ...
                <div class="d-grid p-3">
                    <button type="submit" class="btn-sm btn_main btn_check btn_check"><i class="fa-solid fa-file-pen"></i> Update <?= url(13); ?></button>
                </div>
            <?php endif; ?>
        </form>
